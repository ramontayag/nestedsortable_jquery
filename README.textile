...
This is "mjsarfatti.com":http://mjsarfatti.com/sandbox/nestedSortable/'s nested sortable with a few changes:
...
And this is how you'd parse through the returned params to your server in Ruby assuming my itemName is 'page':
